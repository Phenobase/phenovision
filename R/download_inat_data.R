...
system("python phenobase/download_images.py --observations data/inat/inaturalist-phenobase-data.parquet --image-dir data/inat/images --max-workers 14 --max-images 1000000")
