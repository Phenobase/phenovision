...
vit_tr$push_to_hub("phenobase/phenovisionL")

## model url: https://huggingface.co/phenobase/phenovisionL/commit/eb0725562a522ea0d07a2d9c3008aaaab31a13d9
## model doi: 10.57967/hf/5785
