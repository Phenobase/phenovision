...
pretrained_model <- "siglip_256_v2"  # Options: "plantclef", "imagenet", "imagenet21k", "dino", "mae", "clip"
...
if (pretrained_model == "plantclef") {
  ...
  model_name <- switch(
    ...
    "siglip_256_v2" = "vit_large_patch16_siglip_256.v2_webli",
  ...
  # Use custom position embedding interpolation
  pos_embed$interpolate_pos_embed(vit, timmmodel)
