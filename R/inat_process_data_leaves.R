...
leaf_annot <- read_parquet("/blue/guralnick/share/phenobase_inat_data/metadata/iNat_leaf_annotation/part-0.parquet")
leaf_json <- map(leaf_annot$dynamicProperties, fromJSON)
